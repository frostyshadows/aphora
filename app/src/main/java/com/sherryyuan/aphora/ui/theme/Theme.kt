...
private val TagDarkColorPalette = mapOf(
    TagPastelRed to TagPastelRedDark,
    TagPastelOrange to TagPastelOrangeDark,
    TagPastelYellow to TagPastelYellowDark,
    TagPastelGreen to TagPastelGreenDark,
    TagPastelBlue to TagPastelBlueDark,
    TagPastelPurple to TagPastelPurpleDark,
    TagPastelPink to TagPastelPinkDark,
)

@Composable
fun Color.forTagBackground(): Color =
    if (isSystemInDarkTheme()) TagDarkColorPalette[this] ?: this else this
